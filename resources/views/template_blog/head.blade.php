							...
							<div class="dropdown">
								<div class="dropdown-body">
									<ul class="dropdown-list">
										@foreach ($category_widget as $hasilnya)

											<li><a href=" {{ route('blog.category', $hasilnya->slug) }} "> {{ $hasilnya->name }} </a></li>
			...
			<div id="nav-aside">
				<ul class="nav-aside-menu">
					...
					<li class="has-dropdown"><a>Categories</a>
						<ul class="dropdown">
							@foreach ($category_widget as $has)

								<li><a href=" {{ route('blog.category', $has->slug) }} "> {{ $has->name }} </a></li>
